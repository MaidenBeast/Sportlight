...
$HADOOP_HOME/bin/hdfs dfs -put $HOME/example_data/CDRlog.txt input

$HADOOP_HOME/bin/hadoop jar $HOME/Es2.jar cdr/STDSubscribers input/CDRlog.txt output/result
