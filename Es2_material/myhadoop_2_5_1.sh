...
$HADOOP_HOME/bin/hdfs dfs -put $HOME/example_data/words.txt input

$HADOOP_HOME/bin/hadoop jar $HOME/Es1.jar wordcount/WordCount input/words.txt output/result
