...
$HADOOP_HOME/bin/hdfs dfs -put $HOME/example_data/LastFMlog.txt input

$HADOOP_HOME/bin/hadoop jar $HOME/Es2.jar lastFM/UniqueListeners input/LastFMlog.txt output/result
